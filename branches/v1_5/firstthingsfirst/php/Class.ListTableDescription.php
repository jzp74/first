...
$class_listtabledescription_fields = array(
    DB_ID_FIELD_NAME => array("", FIELD_TYPE_DEFINITION_AUTO_NUMBER, "", COLUMN_NO_SHOW),
    LISTTABLEDESCRIPTION_TITLE_FIELD_NAME => array("LABEL_LIST_NAME", FIELD_TYPE_DEFINITION_TEXT_LINE, DATABASETABLE_UNIQUE_FIELD, COLUMN_SHOW),
    LISTTABLEDESCRIPTION_DESCRIPTION_FIELD_NAME => array("LABEL_LIST_DESCRIPTION", FIELD_TYPE_DEFINITION_TEXT_FIELD, "", COLUMN_SHOW),
    LISTTABLEDESCRIPTION_DEFINITION_FIELD_NAME => array("", FIELD_TYPE_DEFINITION_TEXT_FIELD, "", COLUMN_NO_SHOW),
    LISTTABLEDESCRIPTION_ACTIVE_RECORDS_FIELD_NAME => array("LABEL_LIST_ACTIVE_RECORDS", FIELD_TYPE_DEFINITION_NUMBER, NUMBER_COLUMN_NO_SUMMATION, COLUMN_SHOW),
    LISTTABLEDESCRIPTION_ARCHIVED_RECORDS_FIELD_NAME => array("LABEL_LIST_ARCHIVED_RECORDS", FIELD_TYPE_DEFINITION_NUMBER, NUMBER_COLUMN_NO_SUMMATION, COLUMN_SHOW),
    LISTTABLEDESCRIPTION_CREATOR_FIELD_NAME => array("", FIELD_TYPE_DEFINITION_AUTO_CREATED, NAME_DATE_OPTION_DATE_NAME, COLUMN_NO_SHOW),
    LISTTABLEDESCRIPTION_MODIFIER_FIELD_NAME => array("LABEL_LIST_MODIFIER", FIELD_TYPE_DEFINITION_AUTO_MODIFIED, NAME_DATE_OPTION_DATE_NAME, COLUMN_SHOW)
);
