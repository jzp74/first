...
$regression_test_list_definition = array (
    REGRESSION_TEST_LIST_ID_FIELD => array("LABEL_DEFINITION_AUTO_NUMBER", 1, ""),
    REGRESSION_TEST_LIST_NAME_FIELD => array("LABEL_DEFINITION_TEXT_LINE", 0, ""),
    REGRESSION_TEST_LIST_DESCRIPTION_FIELD => array("LABEL_DEFINITION_TEXT_LINE", 0, ""),
    REGRESSION_TEST_LIST_NOTES1_FIELD => array("LABEL_DEFINITION_NOTES_FIELD", 0, ""),
    REGRESSION_TEST_LIST_STATUS_FIELD => array("LABEL_DEFINITION_SELECTION", 0, "open|busy|pending|close"),
    REGRESSION_TEST_LIST_NOTES2_FIELD => array("LABEL_DEFINITION_NOTES_FIELD", 0, "")
);
