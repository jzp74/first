...
$regression_test_list_definition = array (
    REGRESSION_TEST_LIST_ID_FIELD => array(FIELD_TYPE_DEFINITION_AUTO_NUMBER, "", COLUMN_SHOW),
    REGRESSION_TEST_LIST_NAME_FIELD => array(FIELD_TYPE_DEFINITION_TEXT_LINE, "", COLUMN_SHOW),
    REGRESSION_TEST_LIST_DESCRIPTION_FIELD => array(FIELD_TYPE_DEFINITION_TEXT_LINE, "", COLUMN_SHOW),
    REGRESSION_TEST_LIST_NOTES1_FIELD => array(FIELD_TYPE_DEFINITION_NOTES_FIELD, "", ""),
    REGRESSION_TEST_LIST_STATUS_FIELD => array(FIELD_TYPE_DEFINITION_SELECTION, "open|busy|pending|close", COLUMN_SHOW),
    REGRESSION_TEST_LIST_NOTES2_FIELD => array(FIELD_TYPE_DEFINITION_NOTES_FIELD, "", COLUMN_SHOW),
    REGRESSION_TEST_LIST_ATTACHMENTS_FIELD => array(FIELD_TYPE_DEFINITION_ATTACHMENTS, "", COLUMN_SHOW)
);
...
$regression_test_new_list_definition = array (
    0 => array(REGRESSION_TEST_LIST_ID_FIELD, FIELD_TYPE_DEFINITION_AUTO_NUMBER, "", COLUMN_NO_SHOW),
    6 => array(REGRESSION_TEST_LIST_CREATED_FIELD, FIELD_TYPE_DEFINITION_AUTO_CREATED, NAME_DATE_OPTION_DATE_NAME, COLUMN_SHOW),
    1 => array(REGRESSION_TEST_LIST_NAME_FIELD, FIELD_TYPE_DEFINITION_TEXT_LINE, "", COLUMN_SHOW),
    3 => array(REGRESSION_TEST_LIST_NOTES1_FIELD, FIELD_TYPE_DEFINITION_NOTES_FIELD, "", COLUMN_SHOW),
    2 => array(REGRESSION_TEST_LIST_DESCRIPTION_FIELD, FIELD_TYPE_DEFINITION_TEXT_LINE, "", COLUMN_SHOW),
    4 => array(REGRESSION_TEST_LIST_STATUS_FIELD, FIELD_TYPE_DEFINITION_SELECTION, "open|busy|pending|close", COLUMN_SHOW),
    5 => array(REGRESSION_TEST_LIST_NOTES2_FIELD, FIELD_TYPE_DEFINITION_NOTES_FIELD, "", COLUMN_SHOW),
    7 => array(REGRESSION_TEST_LIST_ATTACHMENTS_FIELD, FIELD_TYPE_DEFINITION_ATTACHMENTS, "", COLUMN_SHOW)
);
...
$regression_test_list_items = array (
    array  (REGRESSION_TEST_LIST_NAME_FIELD => "notes test 1",
            ...
            REGRESSION_TEST_LIST_ATTACHMENTS_FIELD => array(array(0, LISTTABLEATTACHMENT_EMPTY_ATTACHMENT."|-|-|-"))),
